...
const CategoryGrid = ({ heading, subheading }) => {
    ...
    <div className="max-w-7xl mx-auto flex flex-col items-center">
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
        {safeCategories.map((cat) => (
          <div
            key={cat.name}
            className="group relative bg-[#202328] rounded-2xl overflow-hidden shadow-md flex flex-col border border-[#23262b] transition-all inset-0 z-0 group-hover:scale-[1.03] transition-transform duration-300"
            style={{ minHeight: 380 }}
          >
            {/* Card hover scale */}
