...
import { selectCartItems, selectCartTotal, selectCartSubtotal, selectCartItemCount } from '../features/cart/cartSlice';
...
const Checkout = () => {
  ...
  const total = (parseFloat(cartSubtotal) + parseFloat(shipping) + parseFloat(tax)).toFixed(2);
        ...
        <div className="mb-8">
          ...
          <nav className="text-sm mb-4">
            <ol className="flex items-center space-x-2">
              ...
              <li><a href="/cart" className="text-gray-500 hover:text-gray-700">Cart</a></li>
              <li className="text-gray-400">/</li>
